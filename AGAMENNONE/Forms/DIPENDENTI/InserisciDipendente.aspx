<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InserisciDipendente.aspx.cs" Inherits="Forms_DIPENDENTI_InserisciDipendente" %>
        ...
        <div class="container py-5 mt-5">
            <div class="row d-flex justify-content-center align-items-center" style="height: 25px; margin-bottom: 15px; margin-top: -5px">
             ...
             <div class="row" style="height: 30px">
                <div class="col-md-2" style="width: 45%; float: left;">
                    <label class="label" style="width: 15%">Azienda:</label>
                </div>
                <div class="col-md-4" style="width: 50%; float: left;">
                    <asp:DropDownList ID="ddlAzienda" runat="server" Style="width: 100%; margin-left: -5px;" DataSourceID="sdsDDLAzienda" DataTextField="RAGIONESOCIALE" DataValueField="chiave"></asp:DropDownList>
                    <asp:SqlDataSource ID="sdsDDLAzienda" runat="server" ConnectionString="<%$ ConnectionStrings:AGAMENNONEConnectionString %>" SelectCommand="AZIENDE_SelectAll_DDL" SelectCommandType="StoredProcedure"></asp:SqlDataSource>
                </div>             
            </div>
            ...
            <div class="row" style="height: 30px">
               ...
               <%-- <div class="col-md-1" style="width: 8%; float: left;">
                    <asp:TextBox ID="txtPrimoAccesso" runat="server" Style="width: 75%; margin-left: -5px;"></asp:TextBox>
                </div>--%>
