<%@ Page Language="C#" AutoEventWireup="true" CodeFile="InserisciCliente.aspx.cs" Inherits="Forms_CLIENTI_InserisciCliente" %>
         ...
         <div class="container py-5 mt-5">
            ...
            <div class="row" style="height: 30px">
                ...
                <div class="col-md-4" style="width: 25%; float: left;">
                    <asp:TextBox ID="txtTelefono" runat="server" Style="width: 100%; margin-left: -15px;" MaxLength="50"></asp:TextBox>
                </div>
