<%@ Page Title="" Language="C#" MasterPageFile="~/Forms/MasterPage.master" AutoEventWireup="true" CodeFile="Aziende.aspx.cs" Inherits="Forms_Aziende" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="container mt-5 ">
        ...
        <div class="row mt-4">
            <div class="col-lg-11 offset-1" style="overflow: auto">
                ...
                <asp:GridView ID="griglia" runat="server" AutoGenerateColumns="False" DataKeyNames="chiave" DataSourceID="sdsAziende" OnSelectedIndexChanged="griglia_SelectedIndexChanged">
                    <Columns>
    ...
    <asp:Panel
        ...
        <iframe style="width: 98%; height: 388px;" id="Iframe2" src="/Forms/AZIENDE/InserisciAzienda.aspx" runat="server"></iframe>
        <br />
